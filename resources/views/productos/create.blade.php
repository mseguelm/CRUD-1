...
<div class="container">
    <form action="{{url('/productos')}}" method="post" >
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="producto_descripcion" id="producto_descripcion" value="">
        </div>   
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="number" class="form-control" name="producto_profundidad" id="producto_profundidad" value="">
        </div>
        <div class="form-group">
